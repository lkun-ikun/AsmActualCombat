...
class MethodFieldUtils {
    ...
    public static final String NEW_METHOD_OWNER = MonitorConfig.replaceClass
    ...
    static String SETTINGS_SECURE_CLASS2 = 'android/provider/Settings$System'

    static String STORAGE_CLASS = "android/os/Environment"
    static String PERMISSION_CLASS = 'androidx/core/app/ActivityCompat'
    static String PERMISSION_CLASS2 = 'android/app/Activity'
    static String PERMISSION_CLASS3 = 'android/support/v4/app/ActivityCompat'
    static String PERMISSION_CLASS4 = 'androidx/fragment/app/Fragment'
    static String PERMISSION_CLASS5 = 'android/support/v4/app/Fragment'
    static String SENSOR_CLASS = 'android/hardware/SensorManager'
    static String ROUTER_CLASS = 'com/xiaojinzi/component/impl/Router'


    //methodName
    static String GET_DEVICE_ID_METHOD_NAME = "getDeviceId"
    static String GET_STORAGE_METHOD_NAME = "getExternalStorageDirectory"
    ...
    static String GET_PERMISSION_METHOD_NAME = "requestPermissions"
    static String GET_SENSORS_METHOD_NAME = "registerListener"//获取传感器
    static String WITH_METHOD_NAME = "with"
    //desc
    ...
    static String[] EMPTY_VOID_RETURN_STRING_DESC1 = [REQUEST_PERMISSION_DES]
    static String[] EMPTY_VOID_RETURN_STRING_DESC2 = [REQUEST_PERMISSION_DES2]
    ...
    static final String ROUTER_DESC = "(Ljava/lang/String;)Lcom/xiaojinzi/component/impl/FragmentNavigator;"
    static final String REQUEST_PERMISSION_DES = "(Landroid/app/Activity;[Ljava/lang/String;I)V"
    static final String REQUEST_PERMISSION_DES2 = "([Ljava/lang/String;I)V"
    static final String SENSOR_DES = "(Landroid/hardware/SensorListener;I)Z"
    static final String SENSOR_DES1 = "(Landroid/hardware/SensorListener;II)Z"
    static final String SENSOR_DES2 = "(Landroid/hardware/SensorEventListener;Landroid/hardware/Sensor;I)Z"
    static final String SENSOR_DES3 = "(Landroid/hardware/SensorEventListener;Landroid/hardware/Sensor;II)Z"
    static final String SENSOR_DES4 = "(Landroid/hardware/SensorEventListener;Landroid/hardware/Sensor;ILandroid/os/Handler;)Z"
    static final String SENSOR_DES5 = "(Landroid/hardware/SensorEventListener;Landroid/hardware/Sensor;IILandroid/os/Handler;)Z"
//    static String[] SENSOR_RETRUN_DES = [SENSOR_DES, SENSOR_DES1, SENSOR_DES2, SENSOR_DES3, SENSOR_DES4, SENSOR_DES5]
    static String[] SENSOR_RETRUN_DES = [SENSOR_DES]


    static String[] CONTENTRESOLVER_STRING_RETURN_STRING_DESC = [CONTENTRESOLVER_STRING_DESC]
    static String[] ROUTER_RETURN_DES = [ROUTER_DESC]
    static String[] EMPTY_RETURN_LIST = [EMPTY_LIST_DESC]
    static String[] FILE_RETURN = [FILE_DESC]
